...
### IoHT - Dispositivos
Dispositivo | GPIO | *** | Touch | GPIO
--- | --- | --- | --- | ---
NeoPixel | GPIO4 | | RIGHT | GPIO15 
Sensor de Luz | GPIO32 | | CANCEL | GPIO12
Buzzer | GPIO2 | | ENTER | GPIO13
BME680 | GPIO2 | | ENTER | GPIO13
Relay | GPIO2 | | ENTER | GPIO13
OLED | SDA | | SCL | 
